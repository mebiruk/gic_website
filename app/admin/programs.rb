ActiveAdmin.register Program do
  ...
  filter :program_name
  filter :study_level, as: :select, :collection => ["TVET","undergraduate", "graduate", "training","research" ]
  ...
  form do |f|
    ...
    f.inputs "porgram information" do
      ...
      f.input :study_level, as: :select, :collection => ["TVET","undergraduate", "graduate", "training","research"], :include_blank => false
